...
-- VERSION SANS PROCÉDURES STOCKÉES (Compatible OVH)
-- =====================================================
-- Ajoute le suivi du poids, taille, masse grasse/maigre, IMC
-- avec statistiques et badges associés
-- Date : 19 Octobre 2025
-- Version : 1.1 - NO FUNCTION (sans procédures stockées)
-- =====================================================
...
-- =====================================================
-- Note: On supprime IF NOT EXISTS car non supporté par toutes les versions MySQL
-- Si l'index existe déjà, une erreur sera levée mais elle sera ignorée
...
-- VÉRIFICATION
-- =====================================================
SELECT '✅ Migration de composition corporelle terminée (VERSION NO FUNCTION) !' as status;
...
-- NOTES IMPORTANTES
-- =====================================================
-- ⚠️  CETTE VERSION NE CONTIENT PAS DE PROCÉDURES STOCKÉES
-- La vérification des badges se fait maintenant dans le code backend
-- Fichier : backend-fytli/models/bodyCompositionModel.js
-- 
-- Avantages :
-- ✅ Compatible avec tous les hébergements (OVH, etc.)
-- ✅ Pas besoin de privilège SUPER
-- ✅ Plus facile à déboguer
-- ✅ Plus flexible pour la logique métier
-- 
-- =====================================================
-- FIN DE LA MIGRATION
-- =====================================================
